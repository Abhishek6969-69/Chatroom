    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-4 bg-white/15 backdrop-blur-2xl rounded-3xl shadow-2xl shadow-black/40 border border-white/20 p-10 relative z-10 ring-1 ring-white/10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-base font-light tracking-wide">Sign in to your festive chat room</p>
        </div>
        ...
        <p className="text-center text-white/80 text-sm mt-7 font-medium">
          ...
          <Link to="/signup" className="text-blue-200 font-bold hover:text-blue-100 transition-all duration-300 underline underline-offset-2">
            Sign up here
          </Link>
        </p>
      </div>
